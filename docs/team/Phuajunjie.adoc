...
The easyfind feature improves on the find feature. Contact'em now auto updates the result display whenever user inputs a letter with the `find` command word.
