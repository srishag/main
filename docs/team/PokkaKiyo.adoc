...
_Figure 3.3.2.1 : Brief Overview of Command Procedure_
...
image::findtagssequencediagram.png[width="800"]
_Figure 3.3.5.1 : Findtags Sequence Diagram_

Figure 3.3.5.1 above shows the overall sequence diagram and how it works.
