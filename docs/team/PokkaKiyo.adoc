...
_Figure 3.3.2.1 : Brief Overview of Find Tags Command Procedure_

As seen from _Figure 3.3.2.1_ above, the entire command consists of 4 main steps:
...
_Figure 3.3.2.2 : Class Diagram of Find Tags Command_

The figure above is the class diagram of notable classes involved in this command, to aid understanding.
...
_Figure 3.3.5.1 : Findtags Sequence Diagram_

Last but not least, Figure 3.3.5.1 above shows the overall sequence diagram and a final summary of how it works.
