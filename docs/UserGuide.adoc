...
[NOTE]
Export might take several minutes. Please do not close your application meanwhile
...
==== Usage Examples
* `addt th/Homework td/Questions 1 to 4 tdl/23112017.` +
Adds a task with the header `Homework` with a description `Questions 1 to 4` and deadline `23112017`.
* `addt th/Assignment td/Tutorial homework tdl/12122017` +
Adds a task with the header `Assignment` with a description `Tutorial homework` and deadline `12122017`.

==== More Information
You must specify all fields of task headers and description to successfully add tasks to the application.

Deadline is an optional field, however if you choose to enter it you must use the format ddMMyyyy.
